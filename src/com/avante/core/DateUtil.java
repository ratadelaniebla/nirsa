...
public class DateUtil 
{
    ...
    public static DateFormat OUT_DATETIME_FORMAT_ymd = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
    ...
    */
    ...
    public static java.sql.Date toDate( Object value ) throws ParseException
    {
        ...
        {
            if( "".equals( (String)value ) ) return null;
            return new java.sql.Date( OUT_DATETIME_FORMAT_ymd.parse( (String)value ).getTime() );
        }
                
        return new java.sql.Date( OUT_DATETIME_FORMAT_ymd.parse( value.toString() ).getTime() );
    }
