...
public class CocinaConsultaCocinadaWindow extends GenericForwardComposer{
	...
	Textbox txtCocinada2,txtCocinada1, txtCorte, txtTemperatura;
	//Objetos
	...
	public void onClick$btnActualizarFech() throws InterruptedException 
	{
		produccion = null;
		...
		lbxCocina2.setFocus(true);
	}	
	
	

		
	public void onClick$btnActualizarCocina() throws InterruptedException 
	{
		lbxCocina2.getItems().clear();
		txtCocinada2.setText(null);
		txtCorte.setText(null);
		...
		if (lbxProduccionFecha2.getSelectedIndex() == 0)
		{
			...
			lbxProduccionFecha2.setFocus(true);
			return;
		}
		onSelect$lbxProduccionFecha2();
		lbxCocina2.setFocus(true);
	}
	...
	public void onClick$btnActualizarListaCoches() throws InterruptedException 
	{
		...
		{
			Sistema.mensaje("Seleccione cocina");
			lbxCocina2.setFocus(true);
			return;
		}
		
		onSelect$lbxCocina2();
		lbxDestino.setFocus(true);
	}
	...
	public void seleccionarCocinadaDestino(){
		if (lbxCocina2.getSelectedIndex()>0) { //anterior lbxCocinada2
			...
			if(cocinadaDestino.getNumerococinadageneral()!=null){
				...
				txtCorte.setText(String.valueOf(cocinadaDestino.getCorte()));
				txtTemperatura.setText(String.valueOf(cocinadaDestino.getTemperatura()));
			}else{
				txtCocinada2.setText(null);
				txtCorte.setText(null);
				txtTemperatura.setText(null);
