...
public class AutoclaveRegistroMuestraMantenimientoWindow  extends GenericForwardComposer {

	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(AutoclaveRegistroMuestraMantenimientoWindow.class);
	AnnotateDataBinder binder;
	public Datebox dteProduccion, dteHoraDescarga;
	public Listbox lbxParada, lbxCoches, lbxMuestrasDetalle;
	...
	public AutoclaveRegistroMuestraMantenimientoWindow() {
		super();
	...
	public void onChange$dteProduccion() {
		produccion = new ProduccionDAOJpaImpl().getProduccionByFechaDate(dteProduccion.getValue());
		cargalbxParada();
		onSelect$lbxParada();
	}
...
//			binder.loadComponent(lbxMuestrasDetalle);
	...
	public void onClick$btnGrabar() {
		try {
			...
			for (Listitem listitem : listaLI) {
				...
				/*****************/
				grabarInfoCoche(esterilizadoCoche);
	...
	private void grabarInfoCoche(EsterilizadoCoche esterilizadoCoche) throws Exception {
