...
public class EnavasadoControlNetoCorteMantenimientoWindow extends GenericForwardComposer {
	...
	public void onSelect$lbxTurnoProduccion() {
		...
		List<EnvasadoControlNetoCorteDetalle> listaEcfcd = ecncc.getEnvasadoControlNetoCorteDetalles();
	...
	public void onClick$btnGrabar() {
		...
		if (ecncc.getEnvasadoControlNetoCorteDetalles()==null)
			return;
...
//		iniciaFormulario();
	...
	public void onClick$btnEliminarItem() {
		...
		EnvasadoControlNetoCorteDetalleDAO ecfcdDAO = new EnvasadoControlNetoCorteDetalleDAOJpaImpl();
		EnvasadoControlNetoCorteDetalle ecfcd;
		for (Listitem li : listaLIEliminados) {
			
			ecfcd = (EnvasadoControlNetoCorteDetalle)li.getValue();
	...
	private List<EnvasadoControlNetoCorteDetalle> procesaEnvasadoControlNetoCorteDetalle(EnvasadoControlNetoCorteCabecera ecncc) {
		try {
			...
			EnvasadoControlNetoCorteDetalle ecfcd;
			List<EnvasadoControlNetoCorteDetalle> listaECFCD = new ArrayList<EnvasadoControlNetoCorteDetalle>();
			...
			for(Listitem li : listaDetalle) {
				...
				if (li.getValue()!=null)
					...
					ecfcd = new EnvasadoControlNetoCorteDetalle();
				...
				ecfcd.setEnvasadoControlNetoCorteCabecera(ecncc);
