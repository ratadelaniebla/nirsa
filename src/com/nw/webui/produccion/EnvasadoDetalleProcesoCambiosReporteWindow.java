...
public class EnvasadoDetalleProcesoCambiosReporteWindow extends GenericForwardComposer{

	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(EnvasadoDetalleProcesoCambiosReporteWindow.class);
	Datebox dteFecha1;
	Listbox lbxTurno;
	AnnotateDataBinder binder;
	private Produccion produccion;
	public EnvasadoDetalleProcesoCambiosReporteWindow() {
		super();
...
//	}
	...
	public void onClick$btnPdf(Event event) throws SuspendNotAllowedException, JRException, InterruptedException{
		...
		new ProgamaProduccionImpresion().doImprimirProgramaFillWeigth("cambiosFillWeigth.jasper","logo_real.gif", produccion.getIdproduccion(), turno.getIdturno());
	}
	...
	public void onClick$btnExcel(Event event) throws Exception  {
		...
		doImprimir2("cambiosFillWeigth.jasper", "reporteCambiosFillWeigth", produccion.getIdproduccion(), turno.getIdturno());
	}
