...
public class CamaraCajonUbicacionMovimientoImpresionWindow extends GenericForwardComposer{	

	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(CamaraCajonUbicacionMovimientoImpresionWindow.class);
	...
	public CamaraCajonUbicacionMovimientoImpresionWindow() {
		//super();
...
//		int idcamara = 1;
	...
	public void onClick$btnMovimientoCajones() throws SuspendNotAllowedException, JRException, InterruptedException{
		...
		if (dteFecha1.getValue() == null) {
			Sistema.mensaje("Debe ingresar una fecha Inicial valida");
			return;
		}
		if (dteFecha2.getValue() == null) {
			Sistema.mensaje("Debe ingresar una fecha Final valida");
			return;
		}
