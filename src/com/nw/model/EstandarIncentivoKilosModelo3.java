...
/**
 * The persistent class for the estandar_incentivo_kilos_modelo3 database table.
 * 
 */
@Entity
@Table(name="estandar_incentivo_kilos_modelo3")
@NamedQuery(name="EstandarIncentivoKilosModelo3.findAll", query="SELECT e FROM EstandarIncentivoKilosModelo3 e")
public class EstandarIncentivoKilosModelo3 implements Serializable {
	...
	public EstandarIncentivoKilosModelo3() {
	}
