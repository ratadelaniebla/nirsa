...
import com.nw.model.dao.CubaDAO;

@SuppressWarnings("unchecked")
public class CubaDAOJpaImpl extends BaseDaoJpaImpl implements CubaDAO {
    ...
    public CubaDAOJpaImpl(){
//    	emf = Persistence.createEntityManagerFactory("NW");
    	emf = JPAPersistenceManager.getInstance().getEntityManagerFactory();
        em = emf.createEntityManager();   
    }
    
	public List<Cuba> getCubas() {
		return em.createQuery("select c from Cuba c order by c.idcuba").getResultList();
	}
