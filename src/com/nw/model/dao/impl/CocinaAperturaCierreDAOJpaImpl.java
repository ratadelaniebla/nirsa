...
public class CocinaAperturaCierreDAOJpaImpl extends BaseDaoJpaImpl
		implements CocinaAperturaCierreDAO {

	
	/**
	 * METODO QUE OBTIENE LOS REGISTROS de LA TABLA CocinaAperturaCierreDetalle
	 * @return
	 */
    ...
    */
    ...
    @PersistenceContext
	 ...
	 public CocinaAperturaCierreDAOJpaImpl() {
	...
	public List<CocinaAperturaCierreDetalle> obtenerCocinasDetalle(Produccion idPro) {
		...
		try {
			Query query = em
					.createQuery("select c from CocinaAperturaCierreDetalle c where c.estado IN (1,3) and c.produccion=:prod");
	...
	@SuppressWarnings("unchecked")
	public List<CocinaAperturaCierreDetalle> obtenerCocinasReaperturar(Produccion idPro) {
		EntityManagerFactory emf = JPAPersistenceManager.getInstance()
				.getEntityManagerFactory();
		EntityManager em = emf.createEntityManager();
		List<CocinaAperturaCierreDetalle> cocinas = new ArrayList<CocinaAperturaCierreDetalle>();
		...
		try {
			Query query = em
					.createQuery("select c from CocinaAperturaCierreDetalle c where c.produccion=:prod  and c.estadococinada =1 and  c.estado =2");
			query.setParameter("prod", idPro);
			cocinas = (List<CocinaAperturaCierreDetalle>) query
					.getResultList();
	...
	@SuppressWarnings("unchecked")
	public List<CocinaAperturaCierreDetalle> obtenerFinalizarCocinada(Produccion idPro) {
		EntityManagerFactory emf = JPAPersistenceManager.getInstance()
				.getEntityManagerFactory();
		EntityManager em = emf.createEntityManager();
		List<CocinaAperturaCierreDetalle> cocinas = new ArrayList<CocinaAperturaCierreDetalle>();
		...
		try {
			Query query = em
					.createQuery("select c from CocinaAperturaCierreDetalle c where c.estadococinada=1 and c.produccion=:prod order by c.cocina.idcocina");
			query.setParameter("prod", idPro);
			cocinas = (List<CocinaAperturaCierreDetalle>) query
					.getResultList();
	...
	@Override
	public void saveOrUpdate(CocinaAperturaCierreDetalle cocina) {
		EntityManagerFactory emf = JPAPersistenceManager.getInstance()
				.getEntityManagerFactory();
		EntityManager em = emf.createEntityManager();
		try {
...
//			query.setParameter("cocina", cocina);
	...
	@SuppressWarnings("unchecked")
	public List<CocinaAperturaCierreDetalle> obtenerCocinaMaxNumero1(Produccion idPro,Cocina cocina) {
		EntityManagerFactory emf = JPAPersistenceManager.getInstance()
				.getEntityManagerFactory();
		EntityManager em = emf.createEntityManager();
		List<CocinaAperturaCierreDetalle> cocinas = new ArrayList<CocinaAperturaCierreDetalle>();
		...
		try {
			Query query = em
					.createQuery("select cacd from CocinaAperturaCierreDetalle cacd where  cacd.cocina=:cocina and " +
							" cacd.produccion=:prod");
			query.setParameter("cocina", cocina);
			query.setParameter("prod", idPro);
//			cocinas = (CocinaAperturaCierreDetalle) query.getSingleResult();
			cocinas=query.getResultList();
			return cocinas; 
...
@SuppressWarnings("unchecked")
	public List<CocinaAperturaCierreDetalle> obtenerCocinaNumero1(Produccion idPro) {  //,Cocina cocina
		EntityManagerFactory emf = JPAPersistenceManager.getInstance()
				.getEntityManagerFactory();
		EntityManager em = emf.createEntityManager();
		List<CocinaAperturaCierreDetalle> cocinas = new ArrayList<CocinaAperturaCierreDetalle>();
		...
		try {
			Query query = em
					.createQuery("select cacd from CocinaAperturaCierreDetalle cacd where cacd.produccion=:prod" +
							" and cacd.numerococinadageneral is not null  "); //c.cocina=:cocina and 
//			query.setParameter("cocina", cocina);
			query.setParameter("prod", idPro);
			cocinas=query.getResultList();			
			return cocinas;
