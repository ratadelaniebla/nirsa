...
public class DescongeladoDetalleTemperaturaDAOJpaImpl extends BaseDaoJpaImpl implements DescongeladoProcesoDAO{

	private EntityManagerFactory emf;
	private EntityManager em;
	
	
	public DescongeladoDetalleTemperaturaDAOJpaImpl()
	{
...
//	where descongelado_detalle_proceso_temperatura.iddescongeladodetalleproceso=2
	...
	public void guardardescongeladoTemperatura(DescongeladoDetalleProcesoTemperatura descongeladoDetalleTemperatura){
	...
	public void remove(Long vid) {
		...
		try{
		   	 ...
		   	 try {
					t.begin();
					DescongeladoDetalleProcesoTemperatura o = (DescongeladoDetalleProcesoTemperatura) em.find(DescongeladoDetalleProcesoTemperatura.class, vid);
					if (o != null){
						em.remove(o);
						t.commit();
					}
